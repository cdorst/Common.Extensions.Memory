...
{
    public static class IntegerReadOnlySpanByteMapMapper
    {
        public static ReadOnlySpan<byte> GetSpan(in Int16ByteMap map)
            => new[]
            {
                map.Byte0,
                map.Byte1
        ...
        public static ReadOnlySpan<byte> GetSpan(in Int32ByteMap map)
            => new[]
            {
                map.Byte0,
                map.Byte1,
        ...
        public static ReadOnlySpan<byte> GetSpan(in Int64ByteMap map)
            => new[]
            {
                map.Byte0,
                map.Byte1,
        ...
        public static ReadOnlySpan<byte> GetSpan(
            in byte item0,
            in byte item1)
            => new[]
            {
