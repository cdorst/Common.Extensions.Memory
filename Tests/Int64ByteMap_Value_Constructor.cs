...
namespace Tests
{
    public class Int64ByteMap_Value_Constructor
    {
        [Theory]
        [ClassData(typeof(Int64TestData))]
        public void Value_property_should_equal_given_value(Int64 value)
            => Assert.Equal(value, new Int64ByteMap(value).Value);
        ...
        {
            var result = new Int64ByteMap(value);
